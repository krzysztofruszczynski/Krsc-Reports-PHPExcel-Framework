...
/**
 * Class for creating center alignment.
 * 
 * @category KrscReports
 * @package KrscReports_Type
 * @author Krzysztof Ruszczyński <http://www.ruszczynski.eu>
 */
class KrscReports_Type_Excel_PHPExcel_Style_Alignment_Center extends KrscReports_Type_Excel_PHPExcel_Style_Alignment
{
    use StyleConstantsTranslatorTrait;

    protected function _getHorizontal()
    {
        return $this->getTranslatedStyleConstant('PHPExcel_Style_Alignment', 'HORIZONTAL_CENTER');
    }
}
