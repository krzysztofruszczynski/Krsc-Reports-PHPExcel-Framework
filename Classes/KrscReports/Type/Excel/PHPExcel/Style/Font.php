...
class KrscReports_Type_Excel_PHPExcel_Style_Font extends KrscReports_Type_Excel_PHPExcel_Style_Default
{
    ...
    public function getStyleArray() 
    {
        ...
        $aOutput = $this->_attachToArray( $aOutput, $this->getTranslatedStyleKey('superScript'), $this->_getSuperScript() );
        $aOutput = $this->_attachToArray( $aOutput, $this->getTranslatedStyleKey('subScript'), $this->_getSubScript() );
        $aOutput = $this->_attachToArray( $aOutput, 'underline', $this->_getUnderline() );
        $aOutput = $this->_attachToArray( $aOutput, $this->getTranslatedStyleKey('strike'), $this->_getStrike() );
