 ...
 */
class KrscReports_Report_ExampleReportDifferentCellStyles extends KrscReports_Report_ExampleReport
{
    ...
    /**
     * @var array key is availibility value which stores style name to be used 
     */
    protected $_aAvailibilityStyles = array( 
    ...
    protected function _addRow( $sProductName, $sProductPrice, $iProductAvailibility )
    {
        ...
        $aRow[KrscReports_Builder_Excel_PHPExcel_TableDifferentStyles::DATA_STYLE_COLUMN][self::COLUMN_PRODUCT_AVAILIBILITY] =
                $this->_aAvailibilityStyles[$iProductAvailibility];
        $this->_aData[] = $aRow;
        return $this;
    }
    ...
    public function generate()
    {
        ...
        $oFillYellow->setColor($this->getTranslatedStyleConstant('PHPExcel_Style_Color', 'COLOR_YELLOW'));
        ...
        $oFillRed->setColor($this->getTranslatedStyleConstant('PHPExcel_Style_Color', 'COLOR_RED'));
        ...
        $oFillDarkGreen->setColor($this->getTranslatedStyleConstant('PHPExcel_Style_Color', 'COLOR_DARKGREEN'));
        ...
        $oFillDarkRed->setColor($this->getTranslatedStyleConstant('PHPExcel_Style_Color', 'COLOR_DARKRED'));
