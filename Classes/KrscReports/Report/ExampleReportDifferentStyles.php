...
class KrscReports_Report_ExampleReportDifferentStyles extends KrscReports_Report_ExampleReport
{
    ...
    public function generate()
    {
        ...
        $oFillOrangeToRed->setEndColor($this->getTranslatedStyleConstant('PHPExcel_Style_Color', 'COLOR_RED'));
        $oFillOrangeToRed->setType($this->getTranslatedStyleConstant('PHPExcel_Style_Fill', 'FILL_PATTERN_LIGHTVERTICAL'));
