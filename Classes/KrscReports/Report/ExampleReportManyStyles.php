 ...
 */
class KrscReports_Report_ExampleReportManyStyles extends KrscReports_Report_ExampleReport
{
    /**
    ...
    {
        return 'Report with two tables in different worksheets with borders and fillment (difference in style between header and rows).';
    }
